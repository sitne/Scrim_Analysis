...
export function RoundDetails({ rounds, players }: RoundDetailsProps) {
                    ...
                    >
                        ...
                        >
                            <div className="flex items-center gap-4 text-left flex-1">
                                <div className="w-12 h-12 flex items-center justify-center rounded border-2 font-semibold flex-shrink-0"
                                    style={{
                                        backgroundColor: round.winningTeam === 'Red' ? 'rgba(239, 68, 68, 0.15)' : 'rgba(59, 130, 246, 0.15)',
                                        borderColor: round.winningTeam === 'Red' ? '#ef4444' : '#3b82f6',
                                        color: round.winningTeam === 'Red' ? '#fca5a5' : '#93c5fd'
                                    }}>
                                        ...
                                        {round.plantSite && (
                                            <span>
                                                ...
                                                {round.plantRoundTime && (
                                                    <span>- Planted {formatTime(round.plantRoundTime)}</span>
                                                )}
                                            </span>
                                        )}
                                    </div>
