...
export default function JoinTeamPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (!response.ok) {
                setError(data.error || 'チームへの参加に失敗しました')
                return
            }
            ...
            <div className="w-full max-w-md">
                <div className="bg-gray-900 rounded-xl shadow-2xl p-8 border border-gray-800">
                    ...
                    <div className="text-center mb-8">
                        <h1 className="text-2xl font-bold text-white mb-2">チームに参加</h1>
                        <p className="text-gray-400 text-sm">招待コードを入力してチームに参加</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition font-mono"
